...
local function getDeviceSecret()
    ...
    return "mLEBwGWSZpGll1Fl3KBjcPUsS8wcw1id"
end
...
function publishTest()
    if sConnected then
        ...
        aLiYun.publish("/"..PRODUCT_KEY.."/"..getDeviceName().."/user/update","qos1data",1,publishTestCb,"publishTest_"..publishCnt)
    end
end
...
local function connectCbFnc(result)
    ...
    if result then
        ...
        aLiYun.subscribe({["/"..PRODUCT_KEY.."/"..getDeviceName().."/user/get"]=0, ["/"..PRODUCT_KEY.."/"..getDeviceName().."/user/get"]=1})
        --注册数据接收的处理函数
